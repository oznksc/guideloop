...
import { themes } from '@guideloop/core';
import type { ThemeConfig } from '@guideloop/core';

const tailwindTheme = themes.tailwind;
const materialTheme = themes.material;
const antdTheme = themes.antd;
